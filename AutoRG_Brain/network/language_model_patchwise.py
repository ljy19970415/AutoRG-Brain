...
class LanguageModel(nn.Module):
    ...
    def __init__(self, img_patch_num, max_tokens=1024):
        ...
        # config = GPT2Config.from_pretrained(self.checkpoint,n_positions=2048)
        # self.gpt_with_lm_head = GPT2LMHeadModel.from_pretrained(self.checkpoint,config=config,ignore_mismatched_sizes=True)
        ...
        #     nn.Linear(in_features=image_feature_dim, out_features=1024),
        #     nn.ReLU(),

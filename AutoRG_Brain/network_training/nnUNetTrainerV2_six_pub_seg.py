...
class nnUNetTrainerV2(nnUNetTrainer):
    ...
    def validate_from_npy(self, identifiers, modal, step_size: float=0.5, all_in_gpu: bool=False):
        ...
        for identifier in identifiers:
            ...
            out_test = {'path':self.folder_with_preprocessed_data_bucket + '//' + identifier +'.npy'}
            save_json(out_test,"/mnt/petrelfs/leijiayu/nnUNet/AutoRG_Brain_git/AutoRG_Brain/out_test.json")

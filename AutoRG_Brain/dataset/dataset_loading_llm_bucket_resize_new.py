...
class DataLoader3D_bucket(SlimDataLoaderBase):
    def __init__(self, data, patch_size, final_patch_size, batch_size, report=None, has_prev_stage=False,
        ...
        case_dic_FT = json.load(open('case_dic.json','r'))
    ...
    def generate_train_batch(self):
        ...
        if self.mode=='FT':
            ...
            #     if sk in self.list_of_keys_modal[choose_modal]:
            #         choose_dataset.append('six')
            #     else:
            #         choose_dataset.append('FT')
            ...
            # choose_dataset = ['six'] * self.batch_size

...
from experiment_planning_bucket.experiment_planner_baseline_3DUNet import ExperimentPlanner
...
class ExperimentPlanner3D_v21(ExperimentPlanner):
    ...
    def __init__(self, folder_with_cropped_data, preprocessed_output_folder, bucket_folder_with_cropped_data, bucket_preprocessed_output_folder):
        super(ExperimentPlanner3D_v21, self).__init__(folder_with_cropped_data, preprocessed_output_folder, bucket_folder_with_cropped_data, bucket_preprocessed_output_folder)
